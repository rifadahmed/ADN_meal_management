              ...
              <div class="card-body">
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($mealrate as $mealrate)
                    <tr>

                      <td>{{$serial++}}</td>
                      <td>{{$mealrate->meal_rate}}</td>
                      <td>{{$mealrate->effective_date}}</td>
                      <td>{{$mealrate->created_by}}</td>

                      <td>
                        <a  href="{{route('mealrate.edit',$mealrate->id)}}" class="btn btn-warning btn-xs">Edit</a>
