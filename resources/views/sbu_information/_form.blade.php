<div class="card-body">
    <div class="row">
      ...
      <div class="form-group col-md-6">
        <label >Company Name  @if ($errors->has('company_name')) <small class="red-text"> [ {{ $errors->first('company_name') }} ] </small>@endif</label>
        <input type="text" name="company_name" class="form-control" id="company_name" placeholder="ADN digital" required value="{{ old('company_name',isset($data) ? $data->company_name :null) }}">
      </div>
