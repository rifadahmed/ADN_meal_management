<div class="card-body">
    <div class="row">
      ...
      <div class="form-group col-md-6">
        <label >Designation Name  @if ($errors->has('designation_name')) <small class="red-text"> [ {{ $errors->first('designation_name') }} ] </small>@endif</label>
        <input type="text" name="designation_name" class="form-control" id="designation_name" placeholder="Employee,Stuff..." required value="{{ old('designation_name',isset($data) ? $data->designation_name :null) }}">
      </div>
  </div>
</div>
